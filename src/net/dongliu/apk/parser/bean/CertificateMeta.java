...
public class CertificateMeta {
    ...
    /**
     * the signature algorithm OID string. An OID is represented by a set of
     * non-negative whole numbers separated by periods. For example, the string
     * "1.2.840.10040.4.3" identifies the SHA-1 with DSA signature algorithm
     * defined in <a href="http://www.ietf.org/rfc/rfc3279.txt"> RFC 3279:
     * Algorithms and Identifiers for the Internet X.509 Public Key
     * Infrastructure Certificate and CRL Profile </a>.
     */
    ...
    /**
     * first use base64 to encode certificate binary data, and then calculate
     * md5 of base64b string. some programs use this as the certMd5 of
     * certificate
     */
     ...
     * android.content.pm.Signature.toCharsString() (but in the form of a byte
     * array so we can pass it to the MD5 function)...
     */
    ...
    public void setCharsString(String charsString) {
